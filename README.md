# diskDB [![Build Status](https://secure.travis-ci.org/arvindr21/diskDB.png?branch=master)](https://travis-ci.org/arvindr21/diskDB) [![npm version](https://badge.fury.io/js/diskdb.svg)](https://badge.fury.io/js/diskdb)
